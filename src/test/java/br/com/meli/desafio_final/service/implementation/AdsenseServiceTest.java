...
import br.com.meli.desafio_final.model.repository.AdsenseRepository;
...
public class AdsenseServiceTest {
    ...
    public void findById_returnAdsense_whenIdIsValid() {
    ...
    @Test
    public void find_findAdsensesByProductId_whenSuccess() {
        BDDMockito.when(repository.findAll())
                .thenReturn(List.of(AdsenseUtils.newAdsense1ToSave()));
